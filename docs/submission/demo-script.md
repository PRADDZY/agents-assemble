...
Show a complete Prompt Opinion workflow in under 3 minutes.
...
- outputs are workflow artifacts, not just summaries
- evidence is cited to underlying chart data
- the system catches missing workup before the specialist visit is wasted
...
- code walkthroughs
- generic AI claims
- extra specialties that are not polished
